...
/**
 * Pojo класс с данными ticker
 */
public class TickerData {public String symbol;
    ...
    public TickerData() {  // Пустой конструктор
    }
    ...
    // Создаем геттеры, чтобы получать значение полей.
